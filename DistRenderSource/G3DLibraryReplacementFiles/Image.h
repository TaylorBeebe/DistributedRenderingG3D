...
public:
    ...
    */
	...
	/** Loads an image from existing PixelTransferBuffer \a buffer. Performs a copy of pixel data within bounds and returns a buffer of that size **/
	static shared_ptr<Image> Image::fromPixelTransferBuffer1(const shared_ptr<PixelTransferBuffer>& buffer, int width, int height);
    ...
    */
    ...
    [[deprecated]] bool convertToL8();
    [[deprecated]] bool convertToR8();

    /** \deprecated Do not call*/
    [[deprecated]] bool convertToRGB8();

    /** \deprecated Do not call*/
    [[deprecated]] bool convertToRGBA8();
