...
public:
    ...
    */
	...
	/*
		Added by T.Beebe 5/6/19 for Distributed Rendering Project
	*/
	static shared_ptr<PixelTransferBuffer> CombineImages(const Array<shared_ptr<Image> >& images);

	/*
		End of methods aded by T.Beebe on 5/6/19
	*/
